...
\renewcommand{\printloftitle}[1]{\Huge\sffamily #1}
\renewcommand{\printlottitle}[1]{\Huge\sffamily #1}

\newcommand{\tabref}[1]{Tabelle \ref{#1}: \nameref{#1}}

\titleformat{\chapter}{\sffamily\bfseries\Huge}{\selectfont\thechapter}{1em}{}
